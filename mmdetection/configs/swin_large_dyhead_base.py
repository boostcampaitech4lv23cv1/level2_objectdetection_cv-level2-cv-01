...
_base_ = "/opt/ml/level2_objectdetection_cv-level2-cv-01/mmdetection/configs/_base_/default_runtime.py"
...
train_pipeline_1 = [
    ...
    ),  # 밝기, 대조, HSV shift, saturation, hue, RGB shift, 등등 p=0.5로 랜덤으로 적용
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file="/opt/ml/level2_objectdetection_cv-level2-cv-01/eda/train_newf4.json",
    ...
    val=dict(
        ...
        ann_file="/opt/ml/level2_objectdetection_cv-level2-cv-01/eda/valid_newf4.json",
        img_prefix=data_root,
        classes=classes,
