...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov7-w6_training.pt', help='initial weights path')
    ...
    parser.add_argument('--project', default='bc_lv2-object_detection', help='save to project/name')
    parser.add_argument('--entity', default='bc_cv01', help='W&B entity')
